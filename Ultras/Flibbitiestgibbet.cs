...
description: Using 4-7 accounts to kill Flibbitiestgibbet
tags: Flibbitiestgibbet, ultra, voidFlibbitiestgibbet
*/
...
public class Flibbitiestgibbet
{
    ...
    public string OptionsStorage = "Flibbitiestgibbet";
    public List<IOption> Options = new()
    {
        ...
        new Option<ItemToFarm>("Item", "Item to Farm", "Which item to farm (choose 'All' for all items)", ItemToFarm.Void_Essentia),
    ...
    int GetQuantity(ItemToFarm item) => item == ItemToFarm.Void_Essentia ? 1 : quantityToFarm;
